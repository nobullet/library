...
import com.nobullet.algo.KnapsackItem.RepeatableItem;
...
public class KnapsackTest {
  ...
  public void testZeroOne1() {
    List<KnapsackItem> result = Knapsack.zeroOne(80, new int[]{20, 30, 50}, new int[]{60, 90, 100});
    assertListsEqual(Lists.newArrayList(new KnapsackItem(90, 30), new KnapsackItem(100, 50)), result);
  }

  @Test
  public void testZeroOne_2() {
    List<KnapsackItem> result = Knapsack.zeroOne(14, new int[]{5, 10, 6, 5}, new int[]{3, 5, 4, 2});
    assertListsEqual(Lists.newArrayList(new KnapsackItem(3, 5), new KnapsackItem(4, 6)), result);
  }

  @Test
  public void testZeroOne3() {
    List<KnapsackItem> result = Knapsack.zeroOne(13, new int[]{3, 4, 5, 9, 9}, new int[]{1, 6, 6, 7, 6});
    assertListsEqual(Lists.newArrayList(new KnapsackItem(1, 3), new KnapsackItem(6, 4), new KnapsackItem(6, 5)), result);
  }
  ...
  public void testGeneric3_duplicates() {
    ...
    assertListsEqual(Lists.newArrayList(new KnapsackItem(1, 3), new KnapsackItem(6, 4), new KnapsackItem(6, 4), new KnapsackItem(6, 5)), result);
  }
  ...
  public void testGeneric_allItems() {
    ...
    assertListsEqual(Lists.newArrayList(new KnapsackItem(1, 3), new KnapsackItem(6, 4), new KnapsackItem(6, 5),
        new KnapsackItem(6, 9), new KnapsackItem(7, 9)), result);
  }
  ...
  public void testUnbounded() {
    ...
    assertEquals(k.unboundedRecursive(5, new int[] {1, 2, 3}, new int[] {15, 20, 50}), 80);

    assertEquals(k.unboundedWMatrix(5, new int[] {1, 2, 3}, new int[] {15, 20, 50}), 80);

    assertEquals(k.unboundedWMatrix(8, new int[]  {1, 3, 4, 5}, new int[] {15, 50, 60, 90}), 140);
  }
